            ...
            <Modal.Body>
                <Row>
                    ...
                    <Row>
                        ...
                        <Col>
                            <p className='col-3 text-left'>{CK.CodeCK}</p>
                        </Col>
                    </Row>
                    <Row>
                        {' '}
                        ...
                        <Col>
                            <p className='col-3 text-left'>{CK.CK_Type.Designation}</p>{' '}
                        </Col>
                    </Row>
                    ...
                    <Row>
                        ...
                        <Col>
                            <p className='col-3 text-left'>{CK.CK_SousType.Designation}</p>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        ...
                        <Col>
                            <p className='col-3 text-left'>
                                {CK.CK_Contenu?.map((elt, index) => (
                                    <p key={index}>*{elt.Designation}</p>
                                ))}
                            </p>{' '}
                        </Col>
                    </Row>
